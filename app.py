...
def add_water():
    ...
    return jsonify({'status': 'success', 'message': f'Added {amount} liters to tank {tank_id}', 'new_level': tank['level']})
...
def discharge_water():
    ...
    return jsonify({'status': 'success', 'message': f'Discharged {amount} liters from tank {tank_id}', 'new_level': tank['level']})
